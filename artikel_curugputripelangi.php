...
<title>Curug Putri Pelangi</title>
</head>
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='20' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
							<div class="embed-responsive embed-responsive-16by9">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.691347775146!2d106.77347471423077!3d-6.685103067213708!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69cef6a5180b1b%3A0xa360f615def5f1fe!2sCurug%20Putri%20Pelangi!5e0!3m2!1sid!2sid!4v1626437691610!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							</div><br><br>		
						...
						<h4 div class = "text-center">Gallery</h4><hr>
							...
							<a href="img/ppl4.jpg" >
								<img src="img/ppl4.jpg" alt="">
							</a>
							<a href="img/ppl5.jpg" >
								<img src="img/ppl5.jpg" alt="">
							</a>
							<a href="img/ppl6.jpg" >
								<img src="img/ppl6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
