...
<title>Curug 7 Cilember</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='8' ");
			...
			<div class="container">
				...
				<center><div class="service-media"><img src="img/<?php echo $row_query['gambar'];?>"  width="500px" height="350px" ></div></center><br><br>
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.8887564817405!2d106.94397571423059!3d-6.6607066669656305!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b63f19c10cd5%3A0x1bd0ba63d53269aa!2sCurug%207%20Cilember!5e0!3m2!1sid!2sid!4v1626421617125!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/curugcilember1.jpg" >
								<img src="img/curugcilember1.jpg" alt="" >
							</a>
							<a href="img/curugcilember2.jpg" >
								<img src="img/curugcilember2.jpg" alt="">
							</a>
							<a href="img/curugcilember3.jpg" >
								<img src="img/curugcilember3.jpg" alt="">
							</a>
							<a href="img/curugcilember4.jpeg" >
								<img src="img/curugcilember4.jpeg" alt="">
							</a>
							<a href="img/curugcilember5.jpg" >
								<img src="img/curugcilember5.jpg" alt="">
							</a>
							<a href="img/curugcilember6.jpg" >
								<img src="img/curugcilember6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
