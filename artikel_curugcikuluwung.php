...
<title>Curug Cikuluwung</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='1' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63405.38546675757!2d106.64534115!3d-6.667162000000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69d19fa5898f1d%3A0xcabc64f49c1a9954!2sCURUG%20CIKULUWUNG!5e0!3m2!1sid!2sid!4v1626436001367!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Galeri</h4><hr>
							<div class= "gallery">			
							<a href="img/ckl1.jpg" >
								<img src="img/ckl1.jpg" alt="" >
							</a>
							<a href="img/ckl2.jpg" >
								<img src="img/ckl2.jpg" alt="">
							</a>
							<a href="img/ckl3.jpg" >
								<img src="img/ckl3.jpg" alt="">
							</a>
							<a href="img/ckl4.jpg" >
								<img src="img/ckl4.jpg" alt="">
							</a>
							<a href="img/ckl5.jpg" >
								<img src="img/ckl5.jpg" alt="">
							</a>
							<a href="img/ckl6.jpg" >
								<img src="img/ckl6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
