...
<title>Curug Panjang</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='18' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
							<div class="embed-responsive embed-responsive-16by9">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.9860392952614!2d106.93873631423045!3d-6.648651366843352!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b7ccc4def43b%3A0x84d6a5e40e3a1f24!2sCurug%20panjang!5e0!3m2!1sid!2sid!4v1626437750029!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							</div><br><br>		
						<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/pjg1.jpg" >
								<img src="img/pjg1.jpg" alt="" >
							</a>
							<a href="img/pjg2.jpg" >
								<img src="img/pjg2.jpg" alt="">
							</a>
							<a href="img/pjg3.jpg" >
								<img src="img/pjg3.jpg" alt="">
							</a>
							<a href="img/pjg4.jpg" >
								<img src="img/pjg4.jpg" alt="">
							</a>
							<a href="img/pjg5.jpg" >
								<img src="img/pjg5.jpg" alt="">
							</a>
							<a href="img/pjg6.jpg" >
								<img src="img/pjg6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
