...
<title>Curug Ciherang</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->	
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='9' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.0818074823587!2d106.99628041423036!3d-6.636762466723031!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b751d918d66f%3A0xeee07e3c098f5da!2sCurug%20Ciherang!5e0!3m2!1sid!2sid!4v1626436385959!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>				
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/chrg1.jpg" >
								<img src="img/chrg1.jpg" alt="" >
							</a>
							<a href="img/chrg2.jpg" >
								<img src="img/chrg2.jpg" alt="">
							</a>
							<a href="img/chrg3.jpg" >
								<img src="img/chrg3.jpg" alt="">
							</a>
							<a href="img/chrg4.jpg" >
								<img src="img/chrg4.jpg" alt="">
							</a>
							<a href="img/chrg5.jpg" >
								<img src="img/chrg5.jpg" alt="">
							</a>
							<a href="img/chrg-2.jpg" >
								<img src="img/chrg-2.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
