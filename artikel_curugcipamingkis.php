...
<title>Curug Cipamingkis</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='19' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.046190675965!2d107.0105664!3d-6.6411865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b0b5e9e0bb67%3A0xfc7c6143e53ee6fc!2sCurug%20Cipamingkis!5e0!3m2!1sid!2sid!4v1626436088314!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/cks1.jpg" >
								<img src="img/cks1.jpg" alt="" >
							</a>
							<a href="img/cks2.jpg" >
								<img src="img/cks2.jpg" alt="">
							</a>
							<a href="img/cks3.jpg" >
								<img src="img/cks3.jpg" alt="">
							</a>
							<a href="img/cks4.jpg" >
								<img src="img/cks4.jpg" alt="">
							</a>
							<a href="img/cks5.jpg" >
								<img src="img/cks5.jpg" alt="">
							</a>
							<a href="img/cks6.jpg" >
								<img src="img/cks6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
