...
<title>Curug Barong</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='11' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.4178422462096!2d106.9544484!3d-6.5948775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b98678c36513%3A0xd6dd16499c02aa5!2sCurug%20Barong!5e0!3m2!1sid!2sid!4v1626434238142!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>				
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/barong1.jpg" >
								<img src="img/barong1.jpg" alt="" >
							</a>
							<a href="img/barong2.jpg" >
								<img src="img/barong2.jpg" alt="">
							</a>
							<a href="img/barong3.jpg" >
								<img src="img/barong3.jpg" alt="">
							</a>
							<a href="img/barong4.jpg" >
								<img src="img/barong4.jpg" alt="">
							</a>
							<a href="img/barong5.jpg" >
								<img src="img/barong5.jpg" alt="">
							</a>
							<a href="img/barong6.jpg" >
								<img src="img/barong6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
