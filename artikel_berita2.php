...
<title>Berlibur Aman di Masa Pandemi</title>
		...
		<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav navbar-right">
				...
				<li><a href="index.html #login" class="page-scroll">Login</a></li>
			  </ul>
			</div> 
				</div>
				</nav>	
	...
	<div class="container">
		...
		<p> Referensi:</p><a href="https://pigijo.com/blog/2021/03/24/wajib-bawa-8-benda-ini-jika-mau-trip-ke-curug/"><?php echo $row_query ['referensi']; ?> </a><br>
