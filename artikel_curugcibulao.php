...
<title>Curug Cibulao</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='14' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.014404073816!2d106.9508321!3d-6.645132299999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b7a25ed315cd%3A0xe01a984123ce4e6d!2sCurug%20Cibulao!5e0!3m2!1sid!2sid!4v1626433559710!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>					
					</div><br><br>
				<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/cblao1.jpg" >
								<img src="img/cblao1.jpg" alt="" >
							</a>
							<a href="img/cblao2.jpg" >
								<img src="img/cblao2.jpg" alt="">
							</a>
							<a href="img/cblao3.jpg" >
								<img src="img/cblao3.jpg" alt="">
							</a>
							<a href="img/cblao4.jpg" >
								<img src="img/cblao4.jpg" alt="">
							</a>
							<a href="img/cblao5.jpg" >
								<img src="img/cblao5.jpg" alt="">
							</a>
							<a href="img/cblao6.jpg" >
								<img src="img/cblao6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
