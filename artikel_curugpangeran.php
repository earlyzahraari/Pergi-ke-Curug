...
<title>Curug Pangeran</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->	
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='7' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15850.353479421112!2d106.68271546977542!3d-6.697794300000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69d1983daaaab3%3A0xb28d41ae4a0658d8!2sCurug%20Pangeran!5e0!3m2!1sid!2sid!4v1626436735019!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>		
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/pgrn1.jpg" >
								<img src="img/pgrn1.jpg" alt="" >
							</a>
							<a href="img/pgrn2.jpg" >
								<img src="img/pgrn2.jpg" alt="">
							</a>
							<a href="img/pgrn3.jpg" >
								<img src="img/pgrn3.jpg" alt="">
							</a>
							<a href="img/pgrn4.jpg" >
								<img src="img/pgrn4.jpg" alt="">
							</a>
							<a href="img/pgrn5.jpg" >
								<img src="img/pgrn5.jpg" alt="">
							</a>
							<a href="img/pgrn6.jpg" >
								<img src="img/pgrn6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
