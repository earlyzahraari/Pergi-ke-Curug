...
<title>Curug Leuwi Hejo</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->	
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='2' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.4358639849233!2d106.95498029999999!3d-6.5926237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b8538fd00129%3A0xfa8b547834f0ac2c!2sLeuwi%20Hejo%20trip%20trekking!5e0!3m2!1sid!2sid!4v1626437184320!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>		
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/lh1.jpg" >
								<img src="img/lh1.jpg" alt="" >
							</a>
							<a href="img/lh2.jpg" >
								<img src="img/lh2.jpg" alt="">
							</a>
							<a href="img/lh3.jpg" >
								<img src="img/lh3.jpg" alt="">
							</a>
							<a href="img/lh4.jpg" >
								<img src="img/lh4.jpg" alt="">
							</a>
							<a href="img/lh5.jpg" >
								<img src="img/lh5.jpg" alt="">
							</a>
							<a href="img/lh6.jpg" >
								<img src="img/lh6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
