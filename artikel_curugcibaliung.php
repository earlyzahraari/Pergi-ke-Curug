...
<title>Curug Cibaliung</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='12' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.387628080252!2d106.9558988142299!3d-6.598654366338929!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b94322f96831%3A0x48527ed203b300f5!2sCurug%20cibaliung!5e0!3m2!1sid!2sid!4v1626433329538!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/cblng1.jpg" >
								<img src="img/cblng1.jpg" alt="" >
							</a>
							<a href="img/cblng2.jpg" >
								<img src="img/cblng2.jpg" alt="">
							</a>
							<a href="img/cblng3.jpg" >
								<img src="img/cblng3.jpg" alt="">
							</a>
							<a href="img/cblng4.jpg" >
								<img src="img/cblng4.jpg" alt="">
							</a>
							<a href="img/cblng5.jpg" >
								<img src="img/cblng5.jpg" alt="">
							</a>
							<a href="img/cblng6.jpg" >
								<img src="img/cblng6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
