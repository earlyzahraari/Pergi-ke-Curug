...
<title>Curug Putri Kencana</title>
</head>
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='4' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
						<div class="embed-responsive embed-responsive-16by9">
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.395058288922!2d106.93282241422996!3d-6.597725766329572!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69b869f7bedbd7%3A0xf83e4aee23eb911b!2sCurug%20Putri%20Kencana!5e0!3m2!1sid!2sid!4v1626437596560!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
						</div><br><br>		
						<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/pkn1.jpg" >
								<img src="img/pkn1.jpg" alt="" >
							</a>
							<a href="img/pkn2.jpg" >
								<img src="img/pkn2.jpg" alt="">
							</a>
							<a href="img/pkn3.jpg" >
								<img src="img/pkn3.jpg" alt="">
							</a>
							<a href="img/pkn4.jpg" >
								<img src="img/pkn4.jpg" alt="">
							</a>
							<a href="img/pkn5.jpg" >
								<img src="img/pkn5.jpg" alt="">
							</a>
							<a href="img/pkn6.jpg" >
								<img src="img/pkn6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
