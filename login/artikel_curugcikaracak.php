...
<title>Curug Cikaracak</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='3' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.1224804464023!2d106.87178001423159!3d-6.754914967929016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69cb96b4349c4b%3A0x88e398daa18e3719!2sCurug%20Cikaracak!5e0!3m2!1sid!2sid!4v1626435811461!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>				
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/ckrck1.jpg" >
								<img src="img/ckrck1.jpg" alt="" >
							</a>
							<a href="img/ckrck2.jpg" >
								<img src="img/ckrck2.jpg" alt="">
							</a>
							<a href="img/ckrck3.jpg" >
								<img src="img/ckrck3.jpg" alt="">
							</a>
							<a href="img/ckrck4.jpg" >
								<img src="img/ckrck4.jpg" alt="">
							</a>
							<a href="img/ckrck5.jpg" >
								<img src="img/ckrck5.jpg" alt="">
							</a>
							<a href="img/ckrck6.jpg" >
								<img src="img/ckrck6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
