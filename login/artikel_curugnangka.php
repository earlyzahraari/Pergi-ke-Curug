...
<title>Curug Nangka</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->	
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='16' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.8286820188173!2d106.7243093142306!3d-6.668140267041107!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69cfd5ab533c53%3A0xf6427641a4bf1129!2sAir%20Terjun%20Curug%20Nangka!5e0!3m2!1sid!2sid!4v1626437256433!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>		
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/ngk1.jpg" >
								<img src="img/ngk1.jpg" alt="" >
							</a>
							<a href="img/ngk2.jpg" >
								<img src="img/ngk2.jpg" alt="">
							</a>
							<a href="img/ngk3.jpg" >
								<img src="img/ngk3.jpg" alt="">
							</a>
							<a href="img/ngk4.jpg" >
								<img src="img/ngk4.jpg" alt="">
							</a>
							<a href="img/ngk5.jpg" >
								<img src="img/ngk5.jpg" alt="">
							</a>
							<a href="img/ngk6.jpg" >
								<img src="img/ngk6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
