...
<title>Curug 7 Cilember</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='5' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.2645609168126!2d106.90621151423011!3d-6.614015966493499!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c12165130ec3%3A0xd6aa07e3c1d4c5e8!2sCurug%20Bidadari%20Sentul%20Paradise%20Bogor!5e0!3m2!1sid!2sid!4v1626434300113!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>				
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/bidadari1.jpg" >
								<img src="img/bidadari1.jpg" alt="" >
							</a>
							<a href="img/bidadari2.jpg" >
								<img src="img/bidadari2.jpg" alt="">
							</a>
							<a href="img/bidadari3.jpg" >
								<img src="img/bidadari3.jpg" alt="">
							</a>
							<a href="img/bidadari4.jpg" >
								<img src="img/bidadari4.jpg" alt="">
							</a>
							<a href="img/bidadari5.jpg" >
								<img src="img/bidadari5.jpg" alt="">
							</a>
							<a href="img/bidadari6.jpg" >
								<img src="img/bidadari6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
