...
<title>Curug Ciputri</title>
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<!-- Data Database -->
			...
			$query = mysqli_query($koneksi, "SELECT * FROM curug WHERE id ='10' ");
			...
			<div class="container">
				...
				<h4 div class = "text-center">Maps</h4><hr>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7925.403281806707!2d106.7015784348877!3d-6.683833199999992!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69d1c5e2354e8b%3A0xd8dac308b729bed0!2sCurug%20Ciputri!5e0!3m2!1sid!2sid!4v1626436212627!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					</div><br><br>
					<div class="card-header bg-light text-black">
						<h4 div class = "text-center">Gallery</h4><hr>
							<div class= "gallery">			
							<a href="img/cptr1.jpg" >
								<img src="img/cptr1.jpg" alt="" >
							</a>
							<a href="img/cptr2.jpg" >
								<img src="img/cptr2.jpg" alt="">
							</a>
							<a href="img/cptr3.jpg" >
								<img src="img/cptr3.jpg" alt="">
							</a>
							<a href="img/cptr4.jpg" >
								<img src="img/cptr4.jpg" alt="">
							</a>
							<a href="img/cptr5.jpg" >
								<img src="img/cptr5.jpg" alt="">
							</a>
							<a href="img/cptr6.jpg" >
								<img src="img/cptr6.jpg" alt="">
							</a>
						</div>
						<br><br>
					</div>
